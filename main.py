...
📱 Player will see:
"sʜɪʜᴀʙ 🇧 🇴 🇹 -M24 wants to join your team"
...
async def black666(client_id, key, iv):
    banner_text = "[FF0000][B][C] ERROR , WELCOME TO [FFFFFF]sʜɪʜᴀʙ 🇧 🇴 🇹 -M24 [00FF00]___ sʜɪʜᴀʙ 🇧 🇴 🇹 -M24____ BOT ! \n[FFFF00]NEW VERSION NEW FUNCTION !\n[FF0000]TELEGRAM : @sʜɪʜᴀʙ 🇧 🇴 🇹 -M24\n\n"     
    fields = {
        1: 5,
        2: {
            1: int(client_id),
...
Region: {server_name}
[FFDD00]°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°
[00FF00][b][c]BOT MADE BY sʜɪʜᴀʙ 🇧 🇴 🇹 -M24 
"""
            else:
...
[C][B][11EAFD]‎━━━━━━━━━━━━
[C][B][FFB300]Subscribe: [FFFFFF]sʜɪʜᴀʙ 🇧 🇴 🇹 -M24 [00FF00]!!
"""
...
"""
            ...
            # For example:
            title_packet = await convert_kyro_to_your_system(uid, chat_id, key, iv, nickname="sʜɪʜᴀʙ 🇧 🇴 🇹 -M24", title_id=title_id)
...
async def noob(target_uid, chat_id, key, iv, nickname="sʜɪʜᴀʙ 🇧 🇴 🇹 -M24", title_id=None):
    """EXACT conversion with customizable title ID"""
    try:
        # Use provided title_id or get random one
        if title_id is None:
...
async def send_all_titles_sequentiallly(uid, chat_id, key, iv, region, chat_type):
    ...
    # Send initial message
    start_msg = f"""[B][C][00FF00] Noobde sʜɪʜᴀʙ 🇧 🇴 🇹 -M24 ya meku agar tu noob bolra toh tu g a y hai
...
"""
    ...
    try:
        for index, title_id in enumerate(all_titles):
            ...
            # You'll need to use your existing title sending logic here
            # For example:
            title_packet = await noob(uid, chat_id, key, iv, nickname="sʜɪʜᴀʙ 🇧 🇴 🇹 -M24", title_id=title_id)
              ...
              # =================== EMOTE DETECTION ONLY ===================
                    ...
                    try:
                        ...
                        if "NM" in WHITELISTED_UIDS:
                            ...
                            try:
                                ...
                                bot_uid = 13777711848
                                message_text = f" Can't accept Your request Talk to sʜɪʜᴀʙ 🇧 🇴 🇹 -M24"
                ...
                if insquad == True:
                    try:
                        ...
                        message = """[B][C][FF0000]█▓▒░░ WELCOME TO sʜɪʜᴀʙ 🇧 🇴 🇹 -M24 BOT ░░▒▓█
[00FF00]»»————-　★　————-««
[FFFFFF]⚡ BOT POWERED BY:[FF0000] sʜɪʜᴀʙ 🇧 🇴 🇹 -M24
[FFFFFF]🎯 STATUS: [00FF00]ACTIVE 24/7
[FFFFFF]📱 CONTACT: [FFFF00]@sʜɪʜᴀʙ 🇧 🇴 🇹 -M24
[00FF00]»»————-　★　————-««
...
📝 Examples:
/bio Hello World!
/bio 🤖 Bot by sʜɪʜᴀʙ 🇧 🇴 🇹 -M24
/bio Level 70 | Pro Player
/bio Add me: sʜɪʜᴀʙ 🇧 🇴 🇹 -M24
...
"""
                        ...
                        if inPuTMsG.strip().startswith('/wlremove'):
                            ...
                            # Check owner
                            if str(response.Data.uid) != "1055402421":
...
"""
                            ...
                            if str(response.Data.uid) != "1055402421":  # Replace with your actual UID
...
"""
                        ...
                        if inPuTMsG.strip() == '/wllist':
                            ...
                            # Check if owner
                            if str(response.Data.uid) != "1055402421":  # Your UID
...
👥 Whitelisted UIDs:"""
                            ...
                            for uid in WHITELISTED_UIDS:
                                if uid != "1055402421":  # Skip owner since already shown
                                    whitelist_msg += f"\n• {xMsGFixinG(uid)}"
                                    count += 1
                                    if count >= 20:
...
"""
                        ...
                        if inPuTMsG.strip() == "/admin":
                            # Process /admin command - Hardcoded Message (100% Working)
                            admin_message = """[b][c][FF0000]█▓▒░ [FFFF00]★ ᴀᴅᴍɪɴ ᴘʀᴏғɪʟᴇ ★ [FF0000]░▒▓█
[b][c][00FFFF]▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬
[b][FF00FF]👑 ᴀᴅᴍɪɴ ɴᴀᴍᴇ : [00FF00]SHIHAB
[b][FF00FF]🎮 ɢᴀᴍᴇ ɴᴀᴍᴇ  : [FFFF00]S A Y T A M A 모
[b][FF00FF]🆔 ɢᴀᴍᴇ ᴜɪᴅ   : [FFFFFF]1055402421
[b][c][00FFFF]▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬
[b][c][FFA500]📊 ★ sᴛᴀᴛɪsᴛɪᴄs ★
[b][FF4500]💀 ʙʀ ʜᴇᴀᴅsʜᴏᴛ : [00FFFF]67.90%
[b][FF4500]☠️ ᴄs ʜᴇᴀᴅsʜᴏᴛ : [00FFFF]78.23%
[b][c][00FFFF]▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬
[b][c][1E90FF]✈️ ᴛᴇʟᴇɢʀᴀᴍ : [FFFF00]60K+ MEMBER
[b][c][00FFFF]▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬
[b][c][FFA500]📝 ★ ᴀʙᴏᴜᴛ ᴍᴇ ★
[i][FFFFFF]Bot Developer & Pro Player.
[i][FFFFFF]Creating advanced tools for FF.
[i][FFFFFF]Respect is earned, Honesty is appreciated.
[i][FFFFFF]Trust is gained, Loyalty is returned.
[b][c][00FFFF]▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬
[b][c][FF0000]⚡ ᴘᴏᴡᴇʀᴇᴅ ʙʏ : [00FF00]ADMIN FF shihab
[b][c][FF0000]█▓▒░ [FFFF00]★ ᴛʜᴀɴᴋ ʏᴏᴜ ★ [FF0000]░▒▓█"""
...
"{Name} গাঁজা খা !!",
"{Name} তর বি💩চি কালা !!",
"{Name} মিনহাজের বি💩চি খা !!",
"{Name} সিহাবের বি💩চি ও খা !!",
"{Name} চু💩দলিং পং !!",
"{Name} তর দু💩ন PURE BLACK !!",
"{Name} তর নাই বা💩ল তাই তোকে সবাই বলে আবাল !!",
"{Name} তুই ত বোকা চান্দ !!",
"{Name} তর ছোটো নু💩নু !!",
"{Name} তর বাপের বি💩চি খা !!",
"{Name} ফালতু পোলা !!",
"{Name} বেদানা ভাই এর বি💩চি খা !!",
"{Name} তর নাই হাবল তাই তর নাম হাবল !!",
"{Name} তর নাই গাবল তাই তর নাম গাবল !!",
"{Name} হাবল !!",
"{Name} গাবল !!",
"{Name} আবা💩ল",
"{Name} তর দু🤬ন !!",
"{Name} মাদার ইল ল !!",
"{Name} সিহাব ভাই এর পা দুয়া পানি খা !!",
"{Name} মিনহাজের দু💩ন,নু💩নু দুয়া পানি খা !!",
"{Name} FREE FIRE খেলছ কেরে ",
"{Name} খেলবি লুডু!!",
"{Name} নাইলে তর হা, হা, হ,!!",
"{Name} যাই করিস, আমি তোর অব্বা এইডা কখনো ভুলিস না !!",
"{Name} এরপর থেকে আমার সাথে আর বেয়াদবি করবি না ",
"{Name} Worning ⚠️",
]
...
#==================≈===========  /HELP MENU COMMANDS ========================================
                        if inPuTMsG.strip().lower() in ("help", "/help", "menu", "hello", "hi", "shihab" ,):

                            header = f"[C][B][FF00FF]⚜️ [FFFF00]ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ sʜɪʜᴀʙ ʙᴏᴛ [FF00FF]⚜️"
                            await safe_send_message(response.Data.chat_type, header, uid, chat_id, key, iv)
                            await asyncio.sleep(0.2)

                            menu1 = """[B][C][00FFFF]╔══ [FF0000]⚡ [FFFF00]TEAM & BASIC [FF0000]⚡ [00FFFF]══╗
[C][FF00FF]【01】 [FFFFFF]/help  [00FF00]➤ Help Menu
[C][FF00FF]【02】 [FFFFFF]/3     [00FF00]➤ 3 Player Team
[C][FF00FF]【03】 [FFFFFF]/5     [00FF00]➤ 5 Player Team
[C][FF00FF]【04】 [FFFFFF]/6     [00FF00]➤ 6 Player Team
[C][FF00FF]【05】 [FFFFFF]/join  [00FF00]➤ Join Team
[C][FF00FF]【06】 [FFFFFF]/exit  [00FF00]➤ Leave Team
[C][FF00FF]【07】 [FFFFFF]/start [00FF00]➤ Start Match
[C][FF00FF]【08】 [FFFFFF]/kick  [00FF00]➤ Kick Player
[C][00FFFF]╚═════════════════════╝"""
                            await safe_send_message(response.Data.chat_type, menu1, uid, chat_id, key, iv)
                            await asyncio.sleep(0.2)

                            menu2 = """[B][C][FF00FF]╔══ [FF4500]🔥 [FFFF00]SPAM & ATTACK [FF4500]🔥 [FF00FF]══╗
[C][00FFFF]【09】 [FFFFFF]/inv     [FFD700]➤ Invite Player
[C][00FFFF]【10】 [FFFFFF]/lag     [FFD700]➤ Lag Team
[C][00FFFF]【11】 [FFFFFF]/attack  [FFD700]➤ Attack Team
[C][00FFFF]【12】 [FFFFFF]/spam    [FFD700]➤ Spam Join Req
[C][00FFFF]【13】 [FFFFFF]/spm_inv [FFD700]➤ Spam Invite
[C][00FFFF]【14】 [FFFFFF]/ms      [FFD700]➤ Message Spam
[C][00FFFF]【15】 [FFFFFF]/mg      [FFD700]➤ Wave Msg Spam
[C][00FFFF]【16】 [FFFFFF]/dm      [FFD700]➤ Direct Message
[C][FF00FF]╚═════════════════════╝"""
                            await safe_send_message(response.Data.chat_type, menu2, uid, chat_id, key, iv)
                            await asyncio.sleep(0.2)

                            menu3 = """[B][C][00FF00]╔══ [FF0000]🎭 [FFFF00]EMOTE SYSTEM [FF0000]🎭 [00FF00]══╗
[C][FFA500]【17】 [FFFFFF]/emote  [ADFF2F]➤ Emote List
[C][FFA500]【18】 [FFFFFF]/e      [ADFF2F]➤ Self Emote
[C][FFA500]【19】 [FFFFFF]/e uid  [ADFF2F]➤ Target Emote
[C][FFA500]【20】 [FFFFFF]/e mul  [ADFF2F]➤ Multi Emote
[C][FFA500]【21】 [FFFFFF]@evos   [ADFF2F]➤ Evo Cycle Self
[C][FFA500]【22】 [FFFFFF]@evos   [ADFF2F]➤ Evo Cycle User
[C][FFA500]【23】 [FFFFFF]@sevos  [ADFF2F]➤ Stop Cycle
[C][FFA500]【24】 [FFFFFF]/d      [ADFF2F]➤ Emote No Bot
[C][00FF00]╚═════════════════════╝"""
                            await safe_send_message(response.Data.chat_type, menu3, uid, chat_id, key, iv)
                            await asyncio.sleep(0.2)

                            menu4 = """[B][C][FFA500]╔══ [00BFFF]💎 [FFFF00]EXTRA FEATURES [00BFFF]💎 [FFA500]══╗
[C][FF69B4]【25】 [FFFFFF]/play   [00FFFF]➤ Custom Emt
[C][FF69B4]【26】 [FFFFFF]/bundle [00FFFF]➤ Bundle Menu
[C][FF69B4]【27】 [FFFFFF]/set    [00FFFF]➤ Set Bundle
[C][FF69B4]【28】 [FFFFFF]/gali   [00FFFF]➤ Fun Gali
[C][FF69B4]【29】 [FFFFFF]/check  [00FFFF]➤ Check Ban
[C][FF69B4]【30】 [FFFFFF]/info   [00FFFF]➤ Player Info
[C][FF69B4]【31】 [FFFFFF]/like   [00FFFF]➤ Send Likes
[C][FF69B4]【32】 [FFFFFF]/ai     [00FFFF]➤ Ask AI Bot
[C][FFA500]╚═════════════════════╝"""
                            await safe_send_message(response.Data.chat_type, menu4, uid, chat_id, key, iv)
                            await asyncio.sleep(0.2)

                            menu5 = """[B][C][FF1493]╔══ [FFD700]🏆 [FFFFFF]PROFILE & BADGE [FFD700]🏆 [FF1493]══╗
[C][7FFF00]【33】 [FFFFFF]/name   [FFC0CB]➤ Get Name
[C][7FFF00]【34】 [FFFFFF]/bio    [FFC0CB]➤ Get Bio
[C][7FFF00]【35】 [FFFFFF]/visit  [FFC0CB]➤ Profile Visit
[C][7FFF00]【36】 [FFFFFF]/s1     [FFC0CB]➤ Craftland Bdg
[C][7FFF00]【37】 [FFFFFF]/s2     [FFC0CB]➤ V Badge Req
[C][7FFF00]【38】 [FFFFFF]/s3     [FFC0CB]➤ Moderator Bdg
[C][7FFF00]【39】 [FFFFFF]/s4     [FFC0CB]➤ Old V Badge
[C][7FFF00]【40】 [FFFFFF]/s5     [FFC0CB]➤ Pro Badge Req
[C][FF1493]╚═════════════════════╝"""
                            await safe_send_message(response.Data.chat_type, menu5, uid, chat_id, key, iv)
                            await asyncio.sleep(0.2)

                            menu6 = """[B][C][1E90FF]╔══ [FFFF00]⚙️ [00FF00]UTILITIES [FFFF00]⚙️ [1E90FF]══╗
[C][FF4500]【41】 [FFFFFF]/spam_req [87CEEB]➤ Spam Req
[C][FF4500]【42】 [FFFFFF]/admin    [87CEEB]➤ Admin Info
[C][FF4500]【43】 [FFFFFF]/store    [87CEEB]➤ Parche Store
[C][FF4500]【44】 [FFFFFF]/title    [87CEEB]➤ Rare Title
[C][FF4500]【45】 [FFFFFF]/emoji    [87CEEB]➤ Single Emoji
[C][FF4500]【46】 [FFFFFF]/emoji_m  [87CEEB]➤ Multi Emoji
[C][FF4500]【47】 [FFFFFF]/ghost    [87CEEB]➤ Ghost Join
[C][FF4500]【48】 [FFFFFF]bb_lag    [87CEEB]➤ Bundle Spam
[C][1E90FF]╚═════════════════════╝"""
                            await safe_send_message(response.Data.chat_type, menu6, uid, chat_id, key, iv)
                            await asyncio.sleep(0.2)

                            menu7 = """[B][C][FF0000]╔══ [FFFFFF]👑 [FFFF00]ADMIN ONLY [FFFFFF]👑 [FF0000]══╗
[C][00FF7F]【49】 [FFFFFF]/add     [FF4500]➤ Add Friend
[C][00FF7F]【50】 [FFFFFF]/remove  [FF4500]➤ Rem Friend
[C][00FF7F]【51】 [FFFFFF]/add_bio [FF4500]➤ Change Bio
[C][00FF7F]【52】 [FFFFFF]/off     [FF4500]➤ Off Bot
[C][00FF7F]【53】 [FFFFFF]/on      [FF4500]➤ On Bot
[C][00FF7F]【54】 [FFFFFF]/status  [FF4500]➤ Bot Status
[C][00FF7F]【55】 [FFFFFF]/100     [FF4500]➤ 100 Lvl Emt
[C][00FF7F]【56】 [FFFFFF]/100_u   [FF4500]➤ 100 Lvl User
[C][FF0000]╚═════════════════════╝"""
                            await safe_send_message(response.Data.chat_type, menu7, uid, chat_id, key, iv)
                            await asyncio.sleep(0.2)

                            menu8 = """[B][C][008000]╔══ [FFFF00]🤖 [00FFFF]AUTOMATIC [FFFF00]🤖 [008000]══╗
[C][FFD700]【57】 [FFFFFF]Auto Accept Team Invite
[C][FFD700]【58】 [FFFFFF]Auto Reply 'noob'
[C][FFD700]【59】 [FFFFFF]Auto Play Ring After Join
[C][FFD700]【60】 [FFFFFF]Auto Ring For Inviter
[C][008000]╚═════════════════════╝"""
...
async def MaiiiinE():
    ...
    if not credentials:
        ...
        print("📝 Format: uid=4337840717,password=103C8EBB7B6851000B4DE8AB1C5FFC479E6D25BB8C44AE6FC6A4BFB4E14BEF29")
        return None
    ...
    os.system('clear')
    print("=" * 50)
    print("🤖 sʜɪʜᴀʙ 🇧 🇴 🇹 -M24 BOT - INITIALIZING")
    print("=" * 50)
    ...
    os.system('clear')
    print("🤖 sʜɪʜᴀʙ 🇧 🇴 🇹 -M24 BOT - CONNECTING")
    print("=" * 50)
    print("┌────────────────────────────────────┐")
    print("│ ██████████████████████████████████ │")
    print("└────────────────────────────────────┘")
